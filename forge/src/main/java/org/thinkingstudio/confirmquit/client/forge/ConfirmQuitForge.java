package org.thinkingstudio.confirmquit.client.forge;
...
public final class ConfirmQuitForge {
    public ConfirmQuitForge() {
        if (FMLLoader.getDist().isClient()) {
            ModContainer modContainer = ModList.get().getModContainerById(ConfirmQuit.MOD_ID).orElseThrow();
