package org.thinkingstudio.rusurequit.client.screen;
...
import org.thinkingstudio.rusurequit.client.mixin.ScreenAccessor;
...
public class ConfirmScreen extends Screen {
    ...
    public ConfirmScreen(Screen parentScreen, Text message, Runnable confirm) {
        super(Text.translatable("screen.rusurequit.confirm.title"));
