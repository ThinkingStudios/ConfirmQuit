...
public class BedrockStyle extends BaseStyle {
    private static final Identifier WINDOW_TEXTURE = new Identifier(RuSureQuit.MOD_ID, "textures/gui/bedrock/window.png");
    ...
    private void drawWindow(TextRenderer textRenderer, Text title, DrawContext drawContext, int x, int y) {
        ...
        drawContext.fillGradient(x, y, endX, endY, -1072689136, -804253680);
        drawContext.drawTexture(WINDOW_TEXTURE, x, y, 0, 0, 252, 140, 252, 140);
        drawContext.drawText(textRenderer, title, x + 8, y + 6, Colors.BLACK, false);
    }
